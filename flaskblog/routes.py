...
def account():
    ...
    image_user = url_for('static', filename='profile_pics/' + current_user.image_user)
    return render_template('account.html', image_user=image_user, form=form)
...
def update_post(post_id):
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        flash(f'Post Updated Succesful', 'sucess')
